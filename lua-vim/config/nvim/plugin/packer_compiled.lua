...
_G.packer_plugins = {
  ...
  ["coq.artifacts"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/coq.artifacts",
  ...
  ["coq.thirdparty"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/coq.thirdparty",
  ...
  coq_nvim = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/coq_nvim",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
